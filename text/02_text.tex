...
Príklad takto určeného prahu je na obrázku \ref{pic-kalibraciaUsporiadane}.
...
Detailný popis metódy \texttt{FrameForLearningThreshold} je na obrázku \ref{pic-FrameForLearningThreshold}.
...
Rovnako ako v metóde \texttt{Frame} je možné volať metódu \texttt{FrameForLearningThreshold} ľubovoľný počet krát za sekundu, opäť však minimálne dvadsať krát a metóda spracúvava rovnakým spôsobom každú snímku, ktorá prišla po 50 ms od predchádzajúcej spracovanej snímky.

\section{Implementácia AVAD}
Pri implementovaní AVAD sme používali knižnicu SFML \cite{SFML}.
Pracuje sa na tom\ldots buduci tyzden\ldots

\chapter{Testovanie}

Tento týždeň na tom budem pracovať.