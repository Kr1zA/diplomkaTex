...
Model so 68 bodmi má približne 95 MiB, čo je príliš veľa a model s 5 bodmi zas neobsahuje body na perách.
...
\subsection{Metóda \texttt{Fra\-me\-For\-Lear\-ning\-Threshold}}
...
\begin{figure}[H]
	\begin{center}
		...
		\caption{Graf priebehu metódy \texttt{Fra\-me\-For\-Lear\-ning\-Threshold}. Vo vrcholoch sú akcie ktoré sa vykonávajú, šípky znázorňujú výstupy z akcií.}
		\label{pic-FrameForLearningThreshold}
	\end{center}
\end{figure}

Rovnako ako v metóde \texttt{Frame} je možné volať metódu \texttt{Fra\-me\-For\-Lear\-ning\-Threshold} ľubovoľný počet krát za sekundu, opäť však minimálne dvadsať krát a metóda spracúvava rovnakým spôsobom každú snímku, ktorá prišla po 50 ms od predchádzajúcej spracovanej snímky.
...
Poprosili sme niekoľko kolegov a známych  o nahranie týchto videí, kde v trénovacom videu, ktoré malo dĺžku viac ako 10 sekúnd, mali povedať vetu \uv{Toto je trénovacie video.} a okrem toho mať ústa zatvorené a nehýbať nimi.
...
\section{Testovanie bodov na perách}\label{testBodyNaPerach}
...
Z uvedených grafov je vidno, ktorá metóda ma akú presnosť. 
...
Trénovanie najpresnejšieho modelu trvalo približne 28 hodín na počítači  HP Z240 a výsledný model má veľkosť približne 37 MiB. 
